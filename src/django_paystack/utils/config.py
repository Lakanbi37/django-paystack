...
from django_paystack.core.loading import feature_hidden


class PaystackConfigMixin(object):
    """
    Base Paystack app configuration mixin, used to extend :py:class:`django.apps.AppConfig`
    ...
    def get_url_decorator(self, pattern):
        ...
        """
        from django_paystack.utils.decorators import permissions_required
...
class PaystackConfig(PaystackConfigMixin, AppConfig):
    """
    Base Paystack app configuration.
